...
RideshareUMass is a ridesharing web application for the Five College community. It connects riders and drivers in the Five College community through a simple flow for account setup, ride matching, and driver profile management.

## Project Overview

The goal of RideshareUMass is to provide a safer, lower-cost, and more community oriented alternative to generic rideshare platforms tailored for students and campus communities. The app includes separate rider and driver experiences, role based access, and a backend API with PostgreSQL backed persistence. 
